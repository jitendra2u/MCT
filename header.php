...
<div class="log-wrap">
      <div class="container"><!-- Brand and toggle get grouped for better mobile display -->
        	<a class="logo" href="<?php bloginfo('url');?>"><img height="" class="img-responsive" src="<?php echo stripslashes(get_option('mct_logo_url'));?>" width="252" /></a>
	  </div>
		  ...
		  <span class="sr-only">Toggle navigation</span></button>
            <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse">
                <ul class="nav navbar-nav nav-custom">
                     ...
                     <li><a class="page-scroll" href="#whoMedhyne">Who Is Medyhne?</a></li>
                     <li><a class="page-scroll" href="#inspired">What We Offer</a></li>
                     <li><a class="page-scroll" href="#ourprints">Our Prints</a></li>
                     <li><a class="page-scroll" href="#kindwords">Kind Words</a></li>
